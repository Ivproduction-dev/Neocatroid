...
public class InternToExternGenerator {
	...
	static {
        ...
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.NEO3D_X.name(), R.string.formula_neo3d_x);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.NEO3D_Y.name(), R.string.formula_neo3d_y);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.NEO3D_Z.name(), R.string.formula_neo3d_z);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.NEO3D_YAW.name(), R.string.formula_neo3d_yaw);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.NEO3D_PITCH.name(), R.string.formula_neo3d_pitch);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.NEO3D_ROLL.name(), R.string.formula_neo3d_roll);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.NEO3D_SCALE_X.name(), R.string.formula_neo3d_scale_x);
