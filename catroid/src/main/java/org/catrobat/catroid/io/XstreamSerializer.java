...
public final class XstreamSerializer {
	...
	private void prepareXstream(Class projectClass, Class sceneClass) {
        ...
        xstream.alias("brick", NeoSetObjectScaleBrick.class);
        ...
        xstream.alias("brick", NeoSetObjectRotationBrick.class);
        xstream.alias("brick", NeoSetCameraPositionBrick.class);
        xstream.alias("brick", NeoSetCameraRotationBrick.class);
        xstream.alias("brick", NeoCameraTouchLookBrick.class);
        xstream.alias("brick", NeoSetPhysicsStateBrick.class);
        xstream.alias("brick", NeoSetObjectVelocityBrick.class);
        xstream.alias("brick", NeoApplyObjectImpulseBrick.class);
        xstream.alias("brick", NeoSetGravityBrick.class);
        xstream.alias("brick", NeoCameraFollowBrick.class);
        xstream.alias("brick", NeoCameraLookAtBrick.class);
        xstream.alias("brick", NeoMoveObjectForwardBrick.class);
        xstream.alias("brick", NeoTurnObjectTowardBrick.class);
        xstream.alias("brick", NeoSetObjectVisibleBrick.class);
        xstream.alias("brick", NeoClearObjectsBrick.class);
        xstream.alias("script", WhenNeo3DCollidesScript.class);
        xstream.alias("brick", WhenNeo3DCollidesBrick.class);
