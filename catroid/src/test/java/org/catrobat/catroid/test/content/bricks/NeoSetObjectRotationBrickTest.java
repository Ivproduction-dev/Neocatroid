...
public class NeoSetObjectRotationBrickTest {
    ...
    public void testBrickDelegatesToActionFactory() {
        ...
        NeoSetObjectRotationBrick brick = new NeoSetObjectRotationBrick("myCube", 10f, 20f, 30f);
        brick.addActionToSequence(sprite, new ScriptSequenceAction(Mockito.mock(Script.class)));

        verify(actionFactory).createNeoSetObjectRotationAction(
                eq(sprite),
